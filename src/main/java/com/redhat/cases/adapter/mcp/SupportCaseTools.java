...
import com.redhat.cases.domain.model.SupportCase;
import com.redhat.cases.infrastructure.redhat.client.HydraClient;
import com.redhat.cases.infrastructure.redhat.client.KnowledgeBaseClient;
import com.redhat.cases.infrastructure.redhat.dto.AccountInfoDto;
...
public class SupportCaseTools {
        ...
        return Uni.createFrom().item(() -> {
            ...
            try {
                ...
                products.stream()
                    ...
                    .sorted((a, b) -> {
                        String lineA = a.getLine() != null ? a.getLine() : "";
                        String lineB = b.getLine() != null ? b.getLine() : "";
                        int lineCompare = lineA.compareTo(lineB);
    ...
    Uni<ToolResponse> listVersions(
        ...
        return Uni.createFrom().item(() -> {
            ...
            try {
                List<VersionDto> versions = hydraClient.getProductVersions(productCode);
    ...
    Uni<ToolResponse> searchKnowledgeBase(
        ...
        return Uni.createFrom().item(() -> {
            ...
            try {
                List<KnowledgeBaseArticleDto> results = kbClient.search(query, maxResults, product, documentType);
    ...
    Uni<ToolResponse> getSolution(
        ...
        return Uni.createFrom().item(() -> {
            ...
            try {
                Optional<KnowledgeBaseArticleDto> solution = kbClient.getSolution(solutionId);
